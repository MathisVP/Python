...
print("La solution pour le premier zéro de la quatrième équation est :  ", PointFixe(g4_1, -8 ,1e-3, 5e4))
print("La solution pour le deuxième zéro de la quatrième équation est : ", PointFixe(g4_2, 2 ,1e-3, 5e4),"\n")
